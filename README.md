...
[![PyPI version](https://badge.fury.io/py/dev-whois-lookup.svg)](https://pypi.org/project/dev-whois-lookup/)
...
```bash
pip install dev-whois-lookup
```

## Quick Start

```python
from dev_whois_lookup import lookup

# Basic usage
result = lookup("your input here")
print(result)
```
...
from dev_whois_lookup import batch
